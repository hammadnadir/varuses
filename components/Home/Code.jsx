                ...
                <div className='container'>
                    ...
                    <div className='grid gap-[25px] lg:grid-cols-3  md:grid-cols-2 sm:grid-cols-1 grid-cols-1'>
                        <div className='bg-[#E9F9FF] mt-[25px] pt-6 px-[20px] rounded-[10px] cursor-pointer'>
                            <p className='text-[#008BBF] text-[25px] font-normal text-center labelres'>Label Your Product</p>
                        ...
                        <div className='bg-[#E2E2E2] mt-[25px] pt-6 px-[20px]  rounded-[10px] cursor-pointer'>
                            <p className='text-[#008BBF] text-[25px] font-normal text-center labelres'>Scratch Your QR Code</p>
                            <div className='flex items-center'>
                        ...
                        <div className='bg-[#E9F9FF] mt-[25px] pt-6 px-[20px]  rounded-[10px] cursor-pointer'>
                            <p className='text-[#008BBF] text-[25px] font-normal text-center labelres'>Authenticate Your QR Code</p>
                            <div className='flex items-center'>
