            ...
            <div className='container'>
                ...
                <div className='grid gap-[25px] mt-[40px] lg:grid-cols-4  md:grid-cols-2 grid-cols-1'>
                    <div>
                        ...
                        <p className='text-center text-[15px] pt-3'>We are authentic to provide you most secure QR code and validate for only one product</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className='text-center text-[15px] pt-3'>We will provide you instant result of clear verification against the Scanned QR code</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className='text-center text-[15px] pt-3'>verisys system is easy to use and can easily accessible to everyone, everywhere.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className='text-center text-[15px] pt-3'>Generate unlimited number of high resolution QR code artwork files</p>
                    </div>
